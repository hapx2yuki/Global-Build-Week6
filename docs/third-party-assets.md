...
| CriteriaForge提出サムネイル | 実画面の静止画構成 | 本リポジトリの公開体験版・Remotionソース | 2026-07-21 | 本プロジェクト由来。新しい外部画像、音楽、書体ファイルは不使用 | 実画面、製品約束、3回評価状態を1280×720へ再構成 | YouTubeとDevpostのサムネイル | 2026-07-21 |
...
- サムネイルは`video/criteriaforge/src/thumbnail.tsx`から決定論的に書き出し、製品画面にない機能や第三者素材を追加していない。
